...
class TipoDivisionController extends Controller
{
    ...
    {
        return view('tipoDivision.listado');
    }

    public function todo(Request $request){
        if($request->ajax()){
            $paises = TipoDivision::whereEstado(1)->orderBy("id","DESC")->get();
    ...
    {
        return view('tipoDivision.nuevo');
    }
    ...
    public function store(Request $request)
    {
        ...
        $pais->save();
        return redirect()->action('TipoDivisionController@index');
    }
