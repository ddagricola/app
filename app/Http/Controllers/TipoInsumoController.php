...
class TipoInsumoController extends Controller
{
    ...
    {
        return view('tipoInsumo.listado');
    }

    public function todo(Request $request){
        if($request->ajax()){
            $paises = TipoInsumo::whereEstado(1)->orderBy("id","DESC")->get();
    ...
    public function store(Request $request)
    {
        ...
        $pais->save();
        return redirect()->action('TipoInsumoController@index');
    }
