...
class MovimientoBeneficiario extends Model
{
    ...
    public static function beneficiariosIngresoEvento($id){
      ...
      select
	distribucion_movimiento.cantidad as cantidad_parcial,
    ...
    municipio_beneficiario.nombre as municipio_beneficiario,
                ...
                insumo.nombre as insumo
                 from movimiento_beneficiario
                    ...
                    join distribucion_movimiento on distribucion_movimiento.id= movimiento_beneficiario.id_distribucion_movimiento
                    ...
                    where movimiento.id = $id and movimiento_beneficiario.estado = 1 and distribucion_movimiento.estado = 1
