...
<section class="content-header">
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-folder-open"></i> Jefaturas</a></li>
        <li class="active">Listado de jefaturas</li>
    </ol>
</section><br>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-default btn-sm" type="button" id="add">Agregar un nueva nueva jefatura</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
function remove(data){
    $.ajax({
        url: "<?php echo url('jefaturas/remove') ?>"+"/"+data,
        type : 'GET',
        error: function(){
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/jefaturas/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('jefaturas/todo') }}",
            "columnDefs": [ 
                { "data": "ministerio", "targets": 0 },
                { "data": "direccion", "targets": 1 },
