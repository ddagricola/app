...
$(function(){
    ...
    $add.on('click', function(){
        ...
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('renglones/todo') }}",
            "columnDefs": [ 
                { "data": "codigo_partida", "targets": 0,"width":"10%" },
                { "data": "nombre", "targets": 1,"width":"10%" },
                { "data": "fecha_creacion", "targets": 2,"width":"10%"},
                { "data": "email_creacion", "targets": 3,"width":"10%" },
                { "data": "ip_creacion", "targets": 4,"width":"10%" },
                //{ "data": "nombre", "targets": 5,"width":"10%" },
                {
                    "targets": 5,
                    "width":"10%",
                    "data": "id_renglon",
