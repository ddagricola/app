    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">
          ...
          <h4>
              NUEVA DISTRIBUCIÓN EN {{ $item->municipio }}
          </h4>
          @endforeach
        </h4>
      </div>
      <div class="modal-body">
        ...
        {!! csrf_field() !!}
        @foreach($detalle as $item)
          <input type="hidden" name="id_municipio" value="{{$item->id_municipio}}">
        @endforeach
        @foreach($detalle as $item)
          <input type="hidden" name="id_grupo_intervencion" value="{{$item->id_grupo}}">
        @endforeach
        <div class="row">
          <div class="col-md-4">
