...
<section class="content-header">
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-folder-open"></i> Paises</a></li>
        <li class="active">Listado de paises</li>
    </ol>
</section><br>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-default btn-sm" type="button" id="add">Agregar un nuevo país</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
function remove(data){
    $.ajax({
        url: "<?php echo url('paises/remove') ?>"+"/"+data,
        type : 'GET',
        error: function(){
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/paises/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('paises/todo') }}",
            "columnDefs": [ 
