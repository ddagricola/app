...
<section class="content-header">
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-folder-open"></i> Ministerios</a></li>
        <li class="active">Listado de ministerios</li>
    </ol>
</section><br>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-default btn-sm" type="button" id="add">Agregar un nuevo ministerio</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/ministerios/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('ministerios/todo') }}",
            "columnDefs": [ 
