        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Creación de nuevo ministerio</h3>
                </div>
                <div class="box-body">
                    <form class="form" method="POST" action="{{ url('mantenimiento/ministerios') }}" accept-charset="UTF-8">
                        {!! csrf_field() !!}
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" class="form-control" id="pais" name="siglas" required>
                            </fieldset>
                            <fieldset class="form-group">
