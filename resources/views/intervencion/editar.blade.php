        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Edición de Intervención</h3>
                </div>
                <div class="box-body">
                    <form class="form" method="POST" action="{{ url('intervenciones/actualizar', $intervencion->id) }}" accept-charset="UTF-8">
                        {!! csrf_field() !!}
                        <div class="col-md-4">
                            ...
                            <fieldset class="form-group">
                                ...
                                <select class="form-control" name="departamento" id="departamento">
                                    @foreach ($departamentos as $tipo)
                                        @if ($tipo->id == $intervencion->id_departamento)
                            ...
                            <fieldset class="form-group">
                                ...
                                <select class="form-control" name="id_fuente" id="id_fuente">
                                    @foreach ($fuentes as $tipo)
                                        @if ($tipo->id == $intervencion->id_fuente_financiamiento)
                                            <option value="{{ $tipo->id }}" selected>{{ $tipo->codigo_partida }} - {{ $tipo->nombre }}</option>
                                        @else
                            ...
                            <fieldset class="form-group">
                                ...
                                value="{{$intervencion->nombre}}" required>
                            </fieldset>
                            <fieldset class="form-group">
                            ...
                            <?php $valor = "RANDO"?>
                                ...
                                <textarea class="form-group" cols="50" rows="8" id="justificacion" name="justificacion" type="text">{{$intervencion->justificacion}}</textarea>
                            </fieldset>
                            <fieldset class="form-group">
