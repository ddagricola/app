...
<section class="content-header">
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-folder-open"></i> Tipo Insumo</a></li>
        <li class="active">Listado de tipos de insumo</li>
    </ol>
</section><br>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-default btn-sm" type="button" id="add">Agregar un nuevo tipo de insumo</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
function remove(data){
    $.ajax({
        url: "<?php echo url('tipo-insumo/remove') ?>"+"/"+data,
        type : 'GET',
        error: function(){
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/tipo-insumo/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('tipo-insumo/todo') }}",
            "columnDefs": [ 
