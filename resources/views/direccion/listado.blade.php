                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-default btn-sm" type="button" id="add">Agregar una nueva dirección</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/direcciones/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('direcciones/todo') }}",
            "columnDefs": [ 
                { 
                    "data": "ministerio", "targets": 0,
                    "width":"20%"
                },
                { "data": "nombre", "targets": 1,"width":"20%" },
