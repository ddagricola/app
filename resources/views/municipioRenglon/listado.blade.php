...
<section class="content-header">
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-folder-open"></i> Municipio Renglon</a></li>
        <li class="active">Listado de municipios-renglones</li>
    </ol>
</section><br>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-primary btn-sm" type="button" id="add">Agregar un nuevo municipio-renglon</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
function editar(edit){
    location.href = "{{ url('mantenimiento/municipio-renglon/') }}"+"/"+edit+"/edit";
}
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/municipio-renglon/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('municipio-renglon/todo') }}",
            "columnDefs": [ 
                { "data": "departamento", "targets": 0 },
                { "data": "municipio", "targets": 1 },
                { "data": "renglon", "targets": 2},
                { "data": "fuente", "targets": 3 },
                {
                    "targets": 4,
                    "data": "id",
