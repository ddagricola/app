...
<section class="content-header">
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-folder-open"></i> Insumos</a></li>
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-3 pull-left">
                            <button class="btn btn-default btn-sm" type="button" id="add">Agregar un nuevo insumo</button>
                        </div>
                    </div>
                </div>
                <div class="box-body">
...
$(function(){
    ...
    $add.on('click', function(){
        location.href="<?php echo url('mantenimiento/insumos/create') ?>"
    });
        $('#grid-paises').DataTable({
            "order": [[ 0, "desc" ]],
            "ajax": "{{ url('insumos/todo') }}",
            "columnDefs": [ 
                { "data": "tipo_insumo", "targets": 0 },
