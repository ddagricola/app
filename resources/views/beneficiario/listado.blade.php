...
$(function(){
    ...
    $add.on('click', function(){
        ...
        $('#grid-paises').DataTable({
            ...
            "columnDefs": [ 
                { "data": "cui", "targets": 0 },
                { "data": "primer_nombre", "targets": 1},
                { "data": "segundo_nombre", "targets": 2 },
                { "data": "primer_apellido", "targets": 3 },
                { "data": "segundo_apellido", "targets": 4 },
                { "data": "mun", "targets": 5 },
                { "data": "dep", "targets": 6 },
                {
                    "targets": 7,
                    ...
                    "render": function ( data, type, full, meta ) {
                        edit = "<a href='javascript:editar("+data+")' id='edit' class='btn btn-primary btn-sm' data-toggle='tooltip' data-placement='top' title='Boleta'><span class='glyphicon glyphicon-save' aria-hidden='true'></span></a>";
